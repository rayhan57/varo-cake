...
const CakeProducts = ({ cakes }) => {
  return (
    <div className="container mt-24 space-y-3 pb-12 lg:mt-32 lg:pb-20">
      <h2 data-aos="fade-up" className="text-center text-primary lg:text-lg">
        // Produk Kue
      </h2>
      <h1
        data-aos="fade-up"
        className="mx-auto max-w-lg pb-5 text-center font-playfair text-2xl font-bold lg:text-4xl"
      >
